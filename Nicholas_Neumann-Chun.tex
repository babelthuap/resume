...
\section{COMPUTER}
	{\bf Skills:} JavaScript, Node, React, Angular, Express, MongoDB, jQuery, Git, Heroku, HTML/CSS, Bootstrap, \LaTeX
	
	\vspace{-0.1in}
	
	{\bf Exposure:} Java, GraphQL, Flux, Firebase, Python, Ruby on Rails, Scala, Mathematica, jspm, Gulp, Webpack, Mocha, Passport, Foundation 
...
\hl\section{MISC.}
	{\bf Superior Hiking Trail Thru-Hike} \hfill {\sl 2015}
	\begin{itemize}  \itemsep -2pt
	\item A 230-mi.\ (370-km.)\ trek along the shore of Lake Superior
	\end{itemize}
