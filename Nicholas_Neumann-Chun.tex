...
\address{ nicholas.babelthaup@gmail.com \\ 643 Hamline Ave S, St.\ Paul, MN  55116 \\ (651) 491-4928 }
\address{ https://babelthuap.github.io (Homepage) \\ @Babelthuap (Twitter) \\ https://github.com/babelthuap (GitHub) }
...
\section{SUMMARY}
	I am a highly motivated and fast-learning junior web developer. I solve problems with persistence, precision, and teamwork. I am most comfortable with JavaScript, including Node development, Angular, and React. I have a decent background in CS theory and a strong background in math.

\hl\section{COMPUTER}
	{\bf Skills:} JavaScript (most proficient), Node, React, Angular, Express, MongoDB, jQuery, Git, Heroku, Mocha, HTML/CSS, Bootstrap, \LaTeX
	
	\vspace{-0.1in}
	
	{\bf Exposure:} Java (academic), Scala (academic), Python (academic), GraphQL, Flux, Firebase, Gulp, Webpack, Mathematica, Passport, Foundation


\hl\section{EXPERIENCE}
	{\bf Full-Stack Dev \& Code Mentor}, Coding House, San Francisco \hfill {\sl Jan-Feb 2016}
	\begin{itemize}  \itemsep -2pt
	\item Worked in teams creating full-stack JavaScript apps
	\item Focused on learning teamwork, GitHub, MongoDB, Angular and React
	...
	\end{itemize}
	{\bf Math \& Physics Teaching Assistant \& Tutor} \hfill {\sl Sep 2009 - May 2013}
	\begin{itemize}  \itemsep -2pt
	\item While a student at Williams College
	\item As a TA for various classes, held weekly workshops and graded homework
	\item As both a formal and informal tutor, helped students in various math \& physics classes
	\end{itemize}


\hl\section{PROJECTS}
	{\bf Start Coding} -- http://startcoding.org \hfill {\sl Feb 2016}
	\begin{itemize}  \itemsep -2pt
...
\hl\section{PUBLICATIONS}
	...
	\begin{itemize}  \itemsep -2pt
	\item One result of the number theory research done during summer 2011: attacked the problem of extending continued fractions to degrees higher than 2
	\end{itemize}
...
\hl\section{EDUCATION}
	...
	\item Eat, sleep, and breathe MEAN stack development for four intense months
	\item In the second half, mentor new students and work with teams of peers building larger projects
	\end{itemize}

	{\bf Williams College}, Williamstown, MA \hfill {\sl B.A., 2013}
	\begin{itemize}  \itemsep -2pt
	\item Major: Mathematics \hfill GPA: 3.58
	\item Completed four Computer Science courses
	\end{itemize}
...
\hl\section{LANGUAGES}
	...
	{\bf Spanish}, {\sl intermediate level -- studied in 3rd-12th grade, lived in Peru 2014-2015}
