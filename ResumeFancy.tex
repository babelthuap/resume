...
\hl\section{COOL \\ PROJECTS}
	{\bf Green it!} -- http://paulgoblin.github.io/greenit-frontend
	\begin{itemize}  \itemsep -2pt
...
\hl\section{PUBLICATIONS}
	...
	\begin{itemize}  \itemsep -2pt
	\item One result of the number theory research we did during summer 2011, during which we attacked the problem of extending continued fractions to degrees higher than two
	\end{itemize}
