...
\hl\section{COOL \\ PROJECTS}
	{\bf Friend Finder} -- \url{http://young-favorite-users.herokuapp.com}
	\begin{itemize}  \itemsep -2pt
	\item A Facebook clone hacked together in less than a week
	\end{itemize}
	{\bf Errand Optimizer} -- \url{http://babelthuap.github.io/errand-optimizer}
	\begin{itemize}  \itemsep -2pt
	\item Uses a brute-force solution to the traveling salesman problem
	\end{itemize}
	{\bf Towers of Hanoi} -- \url{http://babelthuap.github.io/towers-of-hanoi}
	\begin{itemize}  \itemsep -2pt
...
\hl\section{MISC.}
	...
	\item Wrote for the AMS Grad School Blog (\url{http://blogs.ams.org/mathgradblog})
	\end{itemize}	
